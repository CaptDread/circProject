...
var burgNav = document.querySelector(".burgNav"); // var burgerBlur = document.querySelector(`.blur`)

var toggleBurger = function toggleBurger() {
  if (burgerButt.id != "open") {
    burgerButt.id = "open";
    burgerBar.style.display = "block";
    burgNav.style.display = "block"; // burgerBlur.style.display = 'block';
    // burgerBlur.style.opacity = "90%";
  } else if (burgerButt.id != "close") {
    burgerButt.id = "close";
    burgerBar.style.display = "none";
    burgNav.style.display = "none"; // burgerBlur.style.display = 'none';
  }
